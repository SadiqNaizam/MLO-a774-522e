          ...
          <main className="p-6 pb-[110px]">
            <header className="flex flex-col md:flex-row items-center gap-6 mb-8">\
              <Avatar className="w-40 h-40 md:w-48 md:h-48 shadow-2xl">\
                ...
                <AvatarFallback className="text-5xl bg-muted text-muted-foreground">{artist.name.charAt(0)}</AvatarFallback>\
              </Avatar>\
              <div className="flex-1 text-center md:text-left">\
                <p className="text-xs uppercase text-muted-foreground mb-1">Artist</p>\
                ...
                <div className="flex gap-3 justify-center md:justify-start">\
                    <Button onClick={handlePlayTopSongs} size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground">\
                        <PlayCircle size={20} className="mr-2" /> Play Top Songs\
                    </Button>\
                    <Button onClick={handleFollowArtist} size="lg" variant="outline" className="text-foreground border-border hover:bg-secondary">\
